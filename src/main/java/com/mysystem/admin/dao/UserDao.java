...
public interface UserDao {
    ...
    List<MyUser> getFuzzyUserByPageAndComId( MyUser myUser);
    ...
    @Insert("insert into my_user(dept_id,user_name, password,sex, nick_name, phone, email, status)" +
            " values(#{deptId},#{userName}, #{password},#{sex}, #{nickName}, #{phone}, #{email}, #{status})")
