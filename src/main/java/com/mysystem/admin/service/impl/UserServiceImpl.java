...
import com.mysystem.admin.dao.UserDao;
import com.mysystem.admin.dao.UserJobDao;

import com.mysystem.admin.entity.MyRoleUser;
import com.mysystem.admin.entity.MyUser;
import com.mysystem.admin.entity.MyUserJob;
import com.mysystem.admin.service.UserService;
import com.mysystem.common.exceptionhandler.MyException;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    @DataPermission(deptAlias = "d", userAlias = "u")
    public Result<MyUser> getAllUsersByPageAndComId(Integer offectPosition, Integer limit, MyUser myUser) {
        Page page = PageHelper.offsetPage(offectPosition,limit);
        List<MyUser> fuzzyUserByPageAndComId = userDao.getFuzzyUserByPageAndComId(myUser);
        return Result.ok().count(page.getTotal()).data(fuzzyUserByPageAndComId).code(ResultCode.TABLE_SUCCESS);
    }
     ...
     * @param user 用户对象
     */
    public void insertUserJob(MyUser user)
    {
