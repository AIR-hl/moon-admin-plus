...
import com.mysystem.admin.dao.JobDao;
...
public class JobServiceImpl implements JobService {
    ...
    @Override
    public Result<JobDto> getJobAll(Integer offectPosition, Integer limit, JobQueryDto jobQueryDto) {
        Page page = PageHelper.offsetPage(offectPosition,limit);
        List<JobDto> fuzzyJob = jobDao.getFuzzyJob(jobQueryDto);
