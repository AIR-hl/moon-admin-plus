...
import com.mysystem.security.dto.JwtUserDto;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public JwtUserDto loadUserByUsername(String userName){
        ...
        List<PowerIndexDto> list = powerDao.listByUserId(user.getUserId());
        List<String> collect = list.stream().map(PowerIndexDto ::getPermission).collect(Collectors.toList());
